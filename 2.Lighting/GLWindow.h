...
private:
    ...
    QOpenGLShaderProgram* m_lightingProgram = nullptr;
    QOpenGLShaderProgram* m_lightProgram = nullptr;
    QOpenGLBuffer* m_vbo_cube = nullptr;
    QOpenGLTexture* m_tex_container_diffuse = nullptr;
    QOpenGLTexture* m_tex_container_specular = nullptr;
    QOpenGLTexture* m_tex_spotLight_diffuse = nullptr;
private:
    float m_alpha = 0.0f;
private:
    QMatrix4x4 m_model;
